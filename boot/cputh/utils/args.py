...
def parse_args() -> Args:
    ...
    sing_parser.add_argument("input", help="path to the .cputh file to execute directly")
    sing_parser.add_argument("-o", "--output", required=False, help="produce a Python compiled file at this file path if provided")
